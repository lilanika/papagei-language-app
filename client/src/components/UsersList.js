...
export default class UsersList extends Component {
  ...
  render() {
    ...
    const filteredUsers = this.state.users.filter((eachuser) => {
      return (
        (eachuser.location === this.state.location || !this.state.location) &&
        (eachuser.nativeLanguages === this.state.learningLanguages ||
          !this.state.learningLanguages) &&
        (eachuser.learningLanguages.includes(this.state.nativeLanguages) ||
          !this.state.nativeLanguages)
      );
    });
        ...
        <div className="bg-light">
          <div className=" profile-user  ">
            {filteredUsers.map((user, index) => {
              ...
              return (
                <Link to={`/users/${user._id}`} className=" linkwrapper">
                  <div className="  ">
                    <div className="profile card-color animation " key={index}>
                      <img
                        className="img-profile p-1"
                        src={user.imageUrl}
                        alt=""
                      />
                      <div className="p-1">
                        ...
                        <div className="card-buttons">
                          ...
                          <Link
                            to={`/users/${user._id}/message`}
                            className="btn btn-dark my-2 p-icons  "
                          >
                      ...
                      <ul>
                        <li className="text-primary">
                          <p className="grey">
                            <i class="far fa-comments text-secondary p-icons "></i>
                            speaks
                          </p>
                        ...
                        <li className="text-primary">
                          <p className="grey ">
                            <i class="fas fa-comments text-secondary p-icons  "></i>
                            learns
                          </p>
                        ...
                        <li className="text-primary location-smart ">
                          <p className="grey ">
                            <i class=" fas fa-map-marked-alt p-icons text-secondary  "></i>
                          </p>
                          <h3>{user.location}</h3>
                        </li>
                      </ul>
